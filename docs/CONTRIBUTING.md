...
bun run docker:start:caldav # Start the Radicale and Baikal compatibility servers
bun run integration:caldav # Run the CalDAV lifecycle against Basic and Digest auth
