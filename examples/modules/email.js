  ...
  function set(cfg) {
    ...
    if (exists(cfg)) {
      ...
      if (SH.isConnected()) {
        ...
        cred_tpl.actor.address = config.emailAddress;
        cred_tpl.actor.name = '';
        cred_tpl.object.smtp.username = config.username;
        cred_tpl.object.smtp.password = config.password;
        cred_tpl.object.smtp.host = config.smtpServer;
