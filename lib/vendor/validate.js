 ...
 *
 * imported to sockethub 2013-01-09
 * from https://github.com/json-schema/json-schema/
 *
 */
...
console.log('checkType('+type+','+value+')');
    if(value === undefined){
      if(schema.required){
