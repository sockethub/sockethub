...
//
// TODO - check client manager to figure out about injecting client object as well
// we need to know the actor, and might need the client object to send data
//
var listeners = {
...
XMPP.prototype._getClient = function (job) {
  ...
  return session.getConfig('credentials', job.actor.address).then(function (creds) {
    ...
    if (!client) {
      ...
      self._createClient(fullJid, creds);
