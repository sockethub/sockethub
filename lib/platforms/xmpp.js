...
var Xmpp = function() {
  ...
  pub['request-friend'] = function requestFriend(job) {
    var promise = promising();
  ...
  pub['remove-friend'] = function removeFriend(job) {
    var promise = promising();
  ...
  pub['make-friend'] = function makeFriend(job) {
    var promise = promising();
  ...
  pub.update = function update(job) {
    var promise = promising();
