  ...
  let junk = require(__dirname + "/config.js")();
  let platforms = require(__dirname + "/platforms.js")(Object.keys(packageJSON.dependencies));

  let SockethubSchemas = require("sockethub-schemas");
