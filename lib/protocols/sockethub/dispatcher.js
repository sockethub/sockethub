...
Dispatcher.init = function (myPlatforms, sockethubId) {
  ...
  this.dispatcherChannel = 'sockethub:dispatcher:subsystem:' + sockethubId;
...
Dispatcher.sendSubSystem = function (platform, command, obj) {
  ...
  var channel = 'sockethub:listener:' + platform + ':subsystem:' + this.sockethubId;
...
Dispatcher.shutdown = function () {
  ...
  (function awaitShutdown() {
    ...
    for (var key in _this.platforms.remote) {
      if ((_this.platforms['remote'][key]['ping']['last_received'] !== 0) &&
