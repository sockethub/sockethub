      ...
      if (Dispatcher.inShutdown) {
        ...
        for (var i = 0, numObjs = m.length; i < numObjs; i = i + 1) {
          ...
          if (typeof o.target === 'undefined') {
            o.target = [];
          } else if (typeof o.target.address === 'string') {
          ...
          if (tv4.validate(o, _this.proto.verbs[verb].schema)) {  // incoming json validated
            ...
            console.error(' [dispatcher:'+sessionId+'] JSV validation error: '+tv4.error.message);
          }
        }
