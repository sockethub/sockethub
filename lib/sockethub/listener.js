...
var Listener = function () {
  ...
  var Session;  // Session class is loadeed from redis command,
                // since we need to receive encKey which is generated by
                // dispatcher during init() and sent to listeners via redis
  var platform = {
