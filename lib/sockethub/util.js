...
var redisWrapper = {
  ...
  get: function redisSet(funcName, chan, cb) {
    console.debug(' [util] *** GET called: ' + funcName + ' ' + chan + ' [pool.size: '+pool.getPoolSize()+' avail:'+pool.availableObjectsCount()+' waiting:'+pool.waitingClientsCount()+']');
    pool.acquire(function (err, client) {
      ...
      client[funcName](chan, 0, function (err, replies) {
        ...
        } else if ((funcName === 'brpop') && ((!replies) || (typeof replies[1] === 'undefined'))) {
