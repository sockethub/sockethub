...
function ConfigLoader(param1, param2, cmdline) {
  ...
  var _p;
  try {
    _p_path = path.normalize(path.resolve(config.BASE_PATH, 'package.json', './../../package.json'));
    _p = require(_p_path);
...
=======
>>>>>>> e892be75687375c38a89c1c3bd8e1fde34369d99
...
module.exports = function (p1, p2, c) {
  if (config) {
    ...
    throw new Error('not enough params given to load config');
  } else {
