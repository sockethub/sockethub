...
function ConfigLoader(param1, param2, cmdline) {
  ...
  config.DISPATCHER.LISTENER_INTERVAL_COUNT = config.DISPATCHER.LISTENER_INTERVAL_COUNT || 3;
  config.DISPATCHER.LISTENER_INTERVAL_TIME = config.DISPATCHER.LISTENER_INTERVAL_TIME || 1000;
