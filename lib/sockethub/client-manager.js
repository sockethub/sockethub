...
var ClientManagerWrapper = (function () {
   ...
   *   boolean
   */
  ClientManager.prototype.move = function (platform, sessionId, oldkey, newkey, oldcreds, newcreds) {
    if ((!oldkey) || (!newkey) || (!oldcreds)) {
      console.error(' [client manager:move:' + platform + ':' + sessionId +
                    '] move needs at least three parameters oldkey, newkey and credentials');
      return undefined;
    }
