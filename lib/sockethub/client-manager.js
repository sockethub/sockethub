...
var ClientManagerWrapper = (function () {
        ...
        if ((!clients[platform]) || (!clients[platform][key])) {
          ...
          try {
            console.info(' [client manager:' + platform + ':' + sessionId +
                         '] ending client ' + key);
            console.debug('references: ', clients[platform][key].references);
  ...
  ClientManager.prototype.referenceCount = function (platform, key) {
    ...
    console.debug('client '+key+' reference count: ' + count);
    console.debug('client '+key+' references: ', clients[platform][key].references);
