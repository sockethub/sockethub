...
function run(config) {
  ...
  if (cluster.isMaster) {
    ...
    console.info = function (msg, dump) {
      _console.info.apply(this, ['[#'+cluster.worker.id+']'].concat(Array.prototype.slice.call(arguments)));
    };
    console.error = function (msg, dump) {
      _console.error.apply(this, ['[#'+cluster.worker.id+']'].concat(Array.prototype.slice.call(arguments)));
    };
    console.debug = function (msg, dump) {
      _console.debug.apply(this, ['[#'+cluster.worker.id+']'].concat(Array.prototype.slice.call(arguments)));
    };
    console.warn = function (msg, dump) {
      _console.warn.apply(this, ['[#'+cluster.worker.id+']'].concat(Array.prototype.slice.call(arguments)));
    };
    console.log = function (msg, dump) {
      _console.log.apply(this, ['[#'+cluster.worker.id+']'].concat(Array.prototype.slice.call(arguments)));
    };
