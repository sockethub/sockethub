module.exports = [
  ...
  },
  {
    context: "irc",
    type: "update",
    actor: { type: "person", id: "donkey2018@localhost", name: "donkey2018" },
  ...
  },
  {
    ...
    target: { type: "person", id: "donkey2018@localhost", name: "donkey2018" },
    object: { type: "address" },
  },
  {
    context: "irc",
  ...
  },
  {
    ...
    target: { type: "room", id: "localhost/#kosmos-random", name: "#kosmos-random" },
    object: { type: "topic", content: "testing123" },
  },
  {
    context: "irc",
    type: "send",
    actor: { type: "person", id: "hyper_slvrbckt@localhost", name: "hyper_slvrbckt" },
    target: { type: "room", id: "localhost/#kosmos-random", name: "#kosmos-random" },
  ...
  },
  {
    ...
    target: { type: "room", id: "localhost/#kosmos-random", name: "#kosmos-random" },
    object: { type: "me", content: "is thinking about sending someone to get b33rz" },
  },
  {
    context: "irc",
    type: "update",
  ...
  },
  {
    context: "irc",
    type: "update",
    actor: { type: "person", id: "M-silverbucket@localhost", name: "M-silverbucket" },
    target: { type: "room", id: "localhost/#kosmos", name: "#kosmos" },
    object: { type: "presence", role: "member" },
  },
  {
  ...
  },
  {
    ...
    object: {
      ...
      object: { type: "room", id: "localhost/#Finnish", name: "#Finnish" },
    },
  },
  {
    context: "irc",
  ...
  },
  {
    ...
    object: {
      type: "message",
      content: "You have 30 seconds to identify to your nickname before it is changed.",
    },
    target: { type: "person", id: "boo@localhost", name: "boo" },
  },
  {
    ...
    type: "send",
    actor: { type: "service", id: "localhost" },
    object: { type: "message", content: "You failed to identify in time for the nickname boo" },
    target: { type: "person", id: "boo@localhost", name: "boo" },
  },
  {
    context: "irc",
  ...
  },
  {
    ...
    object: {
      type: "message",
      content: "Last login from: ~slvrbckt@localhost on Feb 09 18:45:19 2022 +0000.",
    },
    target: { type: "person", id: "slvrbckt@localhost", name: "slvrbckt" },
  },
  {
